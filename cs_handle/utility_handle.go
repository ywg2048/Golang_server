...
func processPet(
	...
	if ret == 1 {
		...
		cardNtf = append(cardNtf, makecardNtf(int32(1), int32(20)))
		cardNtf = append(cardNtf, makecardNtf(int32(2), int32(20)))
		cardNtf = append(cardNtf, makecardNtf(int32(3), int32(20)))
		cardNtf = append(cardNtf, makecardNtf(int32(4), int32(20)))
		cardNtf = append(cardNtf, makecardNtf(int32(5), int32(20)))
		cardNtf = append(cardNtf, makecardNtf(int32(6), int32(20)))

		pet_list = append(pet_list, makePet(pet_id, 1, 0, 0, start_star_level, int32(1), int32(150), int32(2), cardNtf))
		if num == 1 {
			//增加的数量只有一个，直接返回啦
			return pet_list, chip_list
		}
	...
	if left_num >= 0 {
		...
		if ret_pet == 1 {
			...
			pet_list = append(pet_list, makePet(res_chip.GetChipType(),
				1, 0, 0, pet_star_level, int32(1), int32(150), int32(2), cardNtf))
		}
	}
