...
func Init() {
	...
	cmdProcessRegister(cspb.Command_kDressReq, DressHandle)
	cmdProcessRegister(cspb.Command_kAddFriendReq, AddFriendHandle)
	cmdProcessRegister(cspb.Command_kFriendmessageReq, FriendmessageHandle)
	cmdProcessRegister(cspb.Command_kFriendlistReq, FriendlistHandle)
	cmdProcessRegister(cspb.Command_kFriendmessageListReq, FriendmessageListHandle)
	...
	cmdProcessRegister(cspb.Command_kLevelUpPageReq, LevelUpPageHandle)
	cmdProcessRegister(cspb.Command_kLevelUpReq, LevelUpHandle)
	...
	cmdProcessRegister(cspb.Command_kAchievementUpdateReq, AchievementupdateHandle)
